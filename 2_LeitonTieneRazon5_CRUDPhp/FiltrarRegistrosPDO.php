...
<body>
    ...
    try {
        if (isset($_POST['enviar'])) {
            ...
            echo "<p style='text-align:center'>Consulta ejecutada: ".$busqueda."</p>";
            $resultado = $consultar_registros->fetchAll();
            echo "<center><table border='1'>";
            echo "<tr><th colspan=6>Lista de Clientes</th></tr>";
            echo "<tr><th>Nit</th><th>Empresa</th><th>Direccion</th><th>Telefono</th><th>Ciudad</th><th>Fecha</th>";
 ...
 confirm(\"Error al consultar los registros......\"); </script>" . $e->getMessage();
    }
    //$conexion = null;
    ?>
</body>
